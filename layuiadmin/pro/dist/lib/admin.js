layui.define(["view", "table", "upload"],
function(e) {
    var a = layui.jquery,
    t = layui.laytpl,
    i = layui.element,
    ...
    F = {
        ...
        sendAuthCode: function(e) {
            ...
            n = function(l) {
                var s = a(e.elem);
                i--,
                i < 0 ? (s.removeClass(f).html("\u83b7\u53d6\u9a8c\u8bc1\u7801"), i = e.seconds, clearInterval(t)) : s.addClass(f).html(i + "\u79d2\u540e\u91cd\u83b7"),
                l || (t = setInterval(function() {
                    n(!0)
                },
                1e3))
            };
            c.off("click", e.elem).on("click", e.elem,
            function() {
        ...
        sideFlexible: function(e) {
            ...
            i = a("#" + p),
            n = F.screen();
            "spread" === e ? (i.removeClass(x).addClass(g), n < 2 ? t.addClass(v) : t.removeClass(v), t.removeClass(C)) : (i.removeClass(g).addClass(x), n < 2 ? t.removeClass(C) : t.addClass(C), t.removeClass(v)),
        ...
        resize: function(e) {
            var a = layui.router(),
            t = a.path.join("-");
            F.resizeFn[t] && (u.off("resize", F.resizeFn[t]), delete F.resizeFn[t]),
            "off" !== e && (e(), F.resizeFn[t] = e, u.on("resize", F.resizeFn[t]))
        },
        resizeFn: {},
        runResize: function() {
            var e = layui.router(),
    ...
    z = F.events = {
        ...
        closeOtherTabs: function(e) {
            ...
            "all" === e ? (a(A + ":gt(0)").remove(), a(h).find("." + b + ":gt(0)").remove()) : (a(A).each(function(e, i) {
                e && e != F.tabsPage.index && (a(i).addClass(t), F.tabsBody(e).addClass(t))
            }), a("." + t).remove())
        },
    ...
    function() {
        ...
        o.ie && o.ie < 10 && r.error("IE" + o.ie + "\u4e0b\u8bbf\u95ee\u53ef\u80fd\u4e0d\u4f73\uff0c\u63a8\u8350\u4f7f\u7528\uff1aChrome / Firefox / Edge \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668", {
            offset: "auto",
            id: "LAY_errorIE"
        })
    } (),
    ...
    function(e) {
        e.siblings(".layui-nav-child")[0] && d.hasClass(C) && (F.sideFlexible("spread"), layer.close(e.data("index"))),
        F.tabsPage.type = "nav"
    }),
    ...
    function() {
        ...
        F.tabsPage.index = t,
        "iframe" === e.attr("lay-attr") ? F.tabsBodyChange(t) : (P(e), F.runResize(), void F.resizeTable())
    }),
    i.on("tabDelete(layadmin-layout-tabs)",
    function(e) {
    ...
    c.on("click", "*[layadmin-event]",
    function() {
        var e = a(this),
        t = e.attr("layadmin-event");
        z[t] && z[t].call(this, e)
    }),
    c.on("mouseenter", "*[lay-tips]",
    function() {
        var e = a(this);
