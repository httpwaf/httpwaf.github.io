...
layui.define(function(e) {
	...
	function() {
		...
		CoreUtil.sendAjax(tablename,null,function (res) {			
            ...
            if(res.xdata != null && res.ydata2 != null ){             	 
               n[0].xAxis[0].data  = res.xdata;	
               n[0].series[0].data = res.ydata2;
              // n[0].series[1].data = res.ydata2;
              // n[0].title.text = res.title[0];
              $("#label1").html( res.title[2] + "日数据趋势");
               r(0);
            }
  ...
  layui.use(["admin", "carousel", "echarts"],
	function() {
		...
		CoreUtil.sendAjax(tablename,null,function (res) {			  
            ...
            if(res.x2data != null && res.y2data2 != null ){             	 
               n[0].xAxis[0].data  = res.x2data;	
               n[0].series[0].data = res.y2data2;
              // n[0].series[1].data = res.ydata2;
               //n[0].title.text = res.title[0];
              $("#label2").html( res.title[2] + "月数据趋势");
               r(0);
            }
